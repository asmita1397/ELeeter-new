                                ...
                                <div style={{ width: '500px' }} className="card m-auto shadow-lg mt-5">
                                    ...
                                    <div className="card-body ">
                                        <form onSubmit={this.pass}>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <MDBInput autocomplete="off" value={this.state.salaryIncrementedFrom} type="number" onKeyPress={this.hideSalaryIncrementedFrom} label="Salary Incremented From" 
                                                ...
                                                <div class="col-6">
                                                    <MDBInput autocomplete="off" value={this.state.salaryIncrementedTo} type="number" onKeyPress={this.hideSalaryIncrementedTo} label="Salary Incremented To" 
