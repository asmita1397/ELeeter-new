    ...
    validation = () => {
        ...
        if ( incrementInEffectDate === "" ||  selectedDate <now) {
            ...
            if (incrementInEffectDate === "") {
                ...
                this.setState({
                    showIncrementInEffectDate: true,
                    errorMsgIncrementInEffectDate: "Increment Effect Date  must greater than  Today's date"
                })
            }
        ...
        if (annualCompensationYear !== "") {
            ...
            if (annualCompensationYear >0) {
                ...
                if (  annualCompensationYear.toString().length >3) {
                    ...
                    this.setState({ showAnnualCompensationYear: true, showAnnualCompensationYearMsg: "should contain 4 digit" })
