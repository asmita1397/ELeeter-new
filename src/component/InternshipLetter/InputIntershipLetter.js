...
export class InputIntershipLetter extends Component {
    ...
    validation = () => {
        ...
        if (internId === "" ||!internId.match(/^([A-Z]){3}([0-9]){6}?$/) ||internId !== "") {
           
            if(internId !==''){

                if(internId.match(/^([A-Z]){3}([0-9]){6}?$/)){
                    ...
                    that.setState({ 
                        showinternId: true,
                        internIdErrMsg:"Intern ID contains Alphanumeric Only!!"
                    })
                }
                                ...
                                <div style={{ width: '500px' }} className="card m-auto shadow-lg mt-5">
                                    ...
                                    <div className="card-body ">
                                        <form onSubmit={this.pass}>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <MDBInput autocomplete="off" value={this.state.startDate} onClick={this.hidestartDate} onKeyPress={this.hidestartDate} type="date" max="2050-12-31" label="Intership Start Date" title="Joining Date" name="startDate" id="startDate" onChange={(event) => {
                                                        this.setState({
                                                ...
                                                <div class="col-md-6">
                                                    <MDBInput autocomplete="off" value={this.state.endDate} onClick={() => { this.hideendDate(); this.hideInvalidDate() }} onKeyPress={() => { this.hideendDate(); this.hideInvalidDate() }} max="2050-12-31" type="date" label="Intership End Date" title="endDate" name="endDate" id="endDate" onChange={(event) => {
                                                        this.setState({
